...
from marlkit.torch.algorithms.adv_irl.adv_irl import AdvIRL
from marlkit.torch.algorithms.adv_irl.disc_models.simple_disc_models import MLPDisc
from marlkit.torch.algorithms.sac.sac_alpha import (
    SoftActorCritic,
)  # SAC Auto alpha version
from marlkit.torch.common.networks import FlattenMlp
from marlkit.torch.common.policies import ReparamTanhMultivariateGaussianPolicy
