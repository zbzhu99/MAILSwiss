...
from marlkit.torch.common.distributions import (
    ReparamMultivariateNormalDiag,
    ReparamTanhMultivariateNormal,
)
from marlkit.torch.common.networks import Mlp
...
class DiscretePolicy(Mlp, ExplorationPolicy):
    ...
    def get_log_prob(self, obs, acts):
        log_probs = super().forward(obs)
        return log_probs.gather(-1, acts.long())
