...
class DiscreteSoftActorCritic(Trainer):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        ), "action space should be taken into SAC alpha"
        self.target_entropy = 0.98 * (-np.log(1 / kwargs["action_space"].n))
    ...
    def train_step(self, batch):
        ...
        """
        if self.train_alpha:
            log_prob = -action_dist.entropy().detach() + self.target_entropy
